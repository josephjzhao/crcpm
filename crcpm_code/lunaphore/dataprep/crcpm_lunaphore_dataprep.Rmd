---
title: "Lunaphore - data prep - cell type retreival"
...
df_ref_lunaphore_celltype <- read_excel(paste0(path,"/data/lunaphore/reference/df_ref_lunaphore_celltype.xlsx"))
...
ggVennDiagram(l_celltype[grep("T cells", names(l_celltype))])
ggVennDiagram(l_celltype[grep("tumor cells", names(l_celltype))])
dev.off()
...
saveRDS(l_lunaphore_crcpm, paste0(path,"/data/lunaphore/l_lunaphore_crcpm.rds"))
# saveRDS(df_expraw_percell, "C:/Users/jzhao/OneDrive/Research_Cloud/NUH_NCIS/gccrc_pm/data/lunaphore/crcpm/peritoneal_processed/df_expraw_percell.rds")
